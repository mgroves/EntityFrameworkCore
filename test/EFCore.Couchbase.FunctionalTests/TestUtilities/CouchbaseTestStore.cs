...
namespace Microsoft.EntityFrameworkCore.Couchbase.TestUtilities
{
    public class CouchbaseTestStore : TestStore
    {
        ...
        public static CouchbaseTestStore Create(string name) => new CouchbaseTestStore(name, shared: false);

        public static CouchbaseTestStore CreateInitialized(string name)
            => (CouchbaseTestStore)Create(name).Initialize(null, (Func<DbContext>)null, null);
        ...
        private CouchbaseTestStore(string name, bool shared = true, string dataFilePath = null)
            : base(name, shared)
        {
            ClientConfiguration = TestEnvironment.ClientConfiguration;
            Authenticator = TestEnvironment.Authenticator;
        ...
        private class TestStoreContext : DbContext
        {
            ...
            {
                optionsBuilder.UseCouchbase(_testStore.ClientConfiguration, _testStore.Authenticator, _testStore.BucketName);
            }
        }
    }
}
